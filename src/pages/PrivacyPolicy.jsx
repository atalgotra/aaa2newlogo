...
return (
    <div style={{paddingTop: '90px',  backgroundColor: 'var(--bg-main)', minHeight: '100vh', paddingBottom: '80px' }}>
      ...
      <div className="container">
        <div style={{ maxWidth: '1100px', margin: '0 auto', backgroundColor: 'var(--bg-surface, #FFFFFF)', border: '1px solid var(--border-light)', padding: 'clamp(32px, 5vw, 60px)', borderRadius: '24px', boxShadow: '0 10px 40px rgba(0,0,0,0.05)' }}>
